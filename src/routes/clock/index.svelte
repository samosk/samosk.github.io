...
<main class="bg-base-100">
	<div class="grid-container bg-base-200">
		<div class="column bg-base-300">
			<div>
				<h3>
				...
				<button
					on:click={() => clock.toggleAlarm()}
					class="button-3d bg-base-200"
					id="C-button1">ToggleAlarm</button
				>
				<input type="time" class="bg-base-200" bind:value={clock.setAlarmFromString} />
				<p id="time" />
				<p id="alarm" />
			</div>
		</div>
		<div class="column bg-base-300">
			...
			<div>
				<button
					on:click={() => clock.toggleAlarm()}
					class="button-3d bg-base-200"
					id="C-button2">ToggleAlarm</button
				>
				<input type="time" class="bg-base-200" bind:value={clock.setAlarmFromString} />
			</div>
		</div>
			...
			<rec>
				<svg width="20" height="10" style="height:inherit">
					<rect
						width="100%"
						height="100%"
						style="fill:rgb(79,79,79);stroke-height:1;stroke:rgb(0,0,0)"
					/>
					<rect
						height="{(clock.time.minute / 60) * 100}%"
						width="50%"
						style="fill:rgb(0,0,0);stroke-height:1;stroke:rgb(0,0,0)"
					/>
					<rect
						height="{clock.time.minute / 60 +
							(clock.time.hour / 24) * 100}%"
						width="50%"
						x="50%"
						style="fill:rgb(0,0,0);stroke-height:1;stroke:rgb(0,0,0)"
					/>
